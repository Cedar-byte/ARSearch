	var PoiRadar = {
		...
		show: function initFn() {
			...
			AR.radar.background = new AR.ImageResource("assets/radar_bg_.png");

			// set the north-indicator image for the radar (not necessary if you don't want to display a north-indicator)
			AR.radar.northIndicator.image = new AR.ImageResource("assets/radar_north_.png");
